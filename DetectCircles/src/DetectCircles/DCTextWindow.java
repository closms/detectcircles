...
/** Uses a TextPanel to displays text in a window.
	@see TextPanel
*/
public class DCTextWindow extends Frame implements ActionListener, FocusListener, ItemListener {
	...
	*/
	public DCTextWindow(String title, String data, int width, int height) {
	...
	@param height	the height of the window in pixels
	*/
	public DCTextWindow(String title, String headings, String data, int width, int height) {
		super(title);
		enableEvents(AWTEvent.WINDOW_EVENT_MASK);
		if (IJ.isLinux()) setBackground(ImageJ.backgroundColor);
		textPanel = new DCTextPanel(title);
	...
	@param height	the height of the window in pixels
	*/
	public DCTextWindow(String path, int width, int height) {
		super("");
		enableEvents(AWTEvent.WINDOW_EVENT_MASK);
		textPanel = new DCTextPanel();
	...
	*/
	...
	public DCTextPanel getTextPanel() {
		return textPanel;
	}
